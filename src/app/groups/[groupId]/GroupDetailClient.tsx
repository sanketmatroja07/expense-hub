              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-500 mt-1">
                    {group.members.length} members • {group.type} group • Updated{" "}
            ...
            <div className="space-y-6">
              ...
              <section className="card p-6">
                ...
                <p className="text-sm text-neutral-500 leading-6">
                  This group page now renders from the same persisted server-backed
                  state as the dashboard, so direct links and refreshes stay in sync.
                </p>
              </section>
            </div>
          </div>
